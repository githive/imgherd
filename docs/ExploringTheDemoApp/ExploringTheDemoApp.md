...
the code for this page [./src/containers/Home/Home.jsx](https://github.com/erikras/react-redux-universal-hot-example/blob/master/src/containers/Home/Home.jsx).  
